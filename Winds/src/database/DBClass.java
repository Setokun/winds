...
public class DBClass{    
    ...
    public static void createStructures(){
    	try {
			...
			DBClass.executeQuery("CREATE TABLE users (id INT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY, email VARCHAR, password VARCHAR, pseudo VARCHAR, userType VARCHAR, current BOOLEAN, music INT, effects INT, resolution INT)");
