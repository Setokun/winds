...
public class DBClass{    
    ...
    public static void createStructures(){
    	try {
			...
			DBClass.executeQuery("CREATE TABLE levels (id INT PRIMARY KEY, name VARCHAR, description VARCHAR, creationDate DATETIME, timeMax INT, levelType VARCHAR, levelStatus VARCHAR, levelMode VARCHAR, idCreator INT, idTheme INT)");
			DBClass.executeQuery("CREATE TABLE themes (id INT PRIMARY KEY, name VARCHAR, description VARCHAR, creationDate DATETIME, idCreator INT)");
    ...
    public static void createTestData(){
		try {
			...
			DBClass.executeQuery("INSERT INTO themes (id, name, description, creationDate, idCreator) VALUES ('2', 'honey','honey','2015-04-30 00:05:00', 5);");
			DBClass.executeQuery("INSERT INTO themes (id, name, description, creationDate, idCreator) VALUES ('3', 'brambles','brambles','2015-04-30 00:05:00', 5);");
			DBClass.executeQuery("INSERT INTO themes (id, name, description, creationDate, idCreator) VALUES ('1', 'pirate','pirate','2015-04-30 00:05:00' ,5);");
